...
if opt.dataset == 'diginetica':
    ...
    if not os.path.exists('eseikatsu2112'):
        os.makedirs('eseikatsu2112')
    pickle.dump(tra, open('eseikatsu2112/train.txt', 'wb'))
    pickle.dump(tes, open('eseikatsu2112/test.txt', 'wb'))
    pickle.dump(tra_seqs, open('eseikatsu2112/all_train_seq.txt', 'wb'))
